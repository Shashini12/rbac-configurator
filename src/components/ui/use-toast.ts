...
function toast(options: ToastOptions) {
  ...
  const title = typeof options.title === 'string' ? options.title : String(options.title)
  const description = typeof options.description === 'string' ? options.description : String(options.description)
  ...
  dispatch({
    ...
    } as ToasterToast,  // Type assertion here
  })
